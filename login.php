...
<body class="bg-danger p-2 text-dark bg-opacity-20">
    <br>
    <center><div class="wrapper bg-success p-2 text-dark bg-opacity-10">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div border=1; class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Usuario</label>
            ...
            <p>¿Eres Administrador? <a href="loginadmin.php">Inicia sesion aqui</a>.</p>
        </form>
    </div> </center>   
</body>
</html>